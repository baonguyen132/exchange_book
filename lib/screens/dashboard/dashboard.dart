...
import 'package:exchange_book/screens/dashboard/page/client/cubit/manage_point/manage_point_cubit.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        providers: [
          ...
          BlocProvider(create: (context) => ManagePointCubit(), lazy: true,),
        ],
